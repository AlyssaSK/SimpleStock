...
public class OrderTest {
    ...
    public void getOrderFromString() throws Exception {
        ...
        Order order = new Order( new Client("C1"), OperationType.SELL, ShareType.A,15,4);
        assertEquals(order, Order.getOrderFromString(testString));
    }

    @Test
    public void isCorresponds() throws Exception {
        Order orderC1 = new Order( new Client("C1"), OperationType.SELL, ShareType.A,15,4);
        Order orderC2 = new Order( new Client("C2"), OperationType.BUY,  ShareType.A,15,4);
    ...
    public void isNotCorrespondsOneOperation() throws Exception {
        Order orderC1 = new Order( new Client("C1"), OperationType.SELL, ShareType.A,15,4);
        Order orderC2 = new Order( new Client("C2"), OperationType.SELL,  ShareType.A,15,4);
    ...
    public void isNotCorrespondsOneClient() throws Exception {
        Order orderC1 = new Order( new Client("C1"), OperationType.SELL, ShareType.A,15,4);
        Order orderC2 = new Order( new Client("C1"), OperationType.BUY,  ShareType.A,15,4);
    ...
    public void isNotCorrespondsDifferentShareType() throws Exception {
        Order orderC1 = new Order( new Client("C1"), OperationType.SELL, ShareType.A,15,4);
        Order orderC2 = new Order( new Client("C2"), OperationType.BUY,  ShareType.C,15,4);
    ...
    public void isNotCorrespondsDifferentPrice() throws Exception {
        Order orderC1 = new Order( new Client("C1"), OperationType.SELL, ShareType.A,15,4);
        Order orderC2 = new Order( new Client("C2"), OperationType.BUY,  ShareType.A,14,4);
    ...
    public void isNotCorrespondsDifferentCount() throws Exception {
        Order orderC1 = new Order( new Client("C1"), OperationType.SELL, ShareType.A,15,4);
        Order orderC2 = new Order( new Client("C2"), OperationType.BUY,  ShareType.A,15,0);
