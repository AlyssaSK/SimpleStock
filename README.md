...
* Если хотите изменить входные параметры, Вам необходимо заменить соответствующие файлы в папке `src\main\resources`
* Файл `result.txt` размещается в той же папке после запуска приложения.
